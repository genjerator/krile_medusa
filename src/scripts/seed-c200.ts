...
export default async function seedC200({ container }: ExecArgs) {
  ...
  const c200 = await upsertProduct({
    ...
    metadata: {
      ...
      // ─── Ausstattung ──────────────────────────────────────────────
      "ausstattung__laenge_siegelschiene_mm": "1 × 465",
      "ausstattung__kammertiefe_breite_mm": 355,
      "ausstattung__anzahl_siegelschienen": "1 × vorne",
      "ausstattung__kammerhoehe_mm": "150 (opt. 220)",
      ...
      "ausstattung__maschinenmasze_geschlossen_mm": "570 × 525 × 360",
      "ausstattung__maschinenmasze_geoeffnet_mm": "570 × 525 × 640",
      "ausstattung__gewicht_kg": 70,
