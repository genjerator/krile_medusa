...
export default async function seedP200({ container }: ExecArgs) {
  ...
  logger.info("🚀 Starting MULTIVAC BASELINE P 200 seed...")
  ...
  const p200 = await upsertProduct({
    title: "MULTIVAC BASELINE P 200",
    handle: "multivac-baseline-p200",
    subtitle: "Tabletop vacuum chamber machine with gas flushing option",
    images: [
      { url: `${BASE}/products/tabletop/p200-overview.jpg` },
      { url: `${BASE}/products/tabletop/p200-spec.jpg` },
    ],
    description:
      "The MULTIVAC BASELINE P 200 is a versatile tabletop vacuum chamber machine with a usable " +
      "chamber volume of 305 × 300 × 110 mm and a pump capacity of 8 m³/h. It is available with " +
      "an optional gas flushing unit for MAP packaging and an alternative lid height of 170 mm for " +
      "taller products.\n\n" +
      "The P 200 features Doppelnaht-Trennsiegelung sealing, a plug-in sealing bar, MCB01 control " +
      "unit, and meets GS safety standards. A mobile trolley is available as an option.\n\n" +
      "Specifications: Chamber volume 305 × 300 × 110 mm | Machine dimensions 380 × 510 × 310 mm | " +
      "Weight ca. 36 kg | Pump capacity 8 m³/h | Sealing length 305 mm | 230V 50Hz / 110V 60Hz",
    status: "published",
    weight: 36000,
    length: 510,
    width: 380,
    ...
    metadata: {
      ...
      "ausstattung__kammerabmessung_mm": "305 × 300 × 110",
      "ausstattung__maschinenabmessung_mm": "380 × 510 × 310",
      "ausstattung__gewicht_kg": "ca. 36",
      "ausstattung__pumpenleistung_m3h": 8,
      "ausstattung__siegelung": "Doppelnaht-Trennsiegelung 1×3mm, 1×1mm",
      "ausstattung__siegelschiene": "steckbar",
      "ausstattung__nutzbare_siegellaenge_mm": 305,
      "ausstattung__steuerung": "MCB01",
      "ausstattung__spannung": "230V 50Hz / 110V 60Hz",
      "optionen__begasungseinrichtung": "optional",
      "optionen__alternative_deckelhöhe_mm": "170",
      "optionen__fahrbares_untergestell": "optional",
    },
    options: [{ title: "Voltage", values: ["230V 50Hz (EU)", "110V 60Hz (US)"] }],
    variants: [
      { title: "P 200 – Standard (230V EU)", sku: "MULTIVAC-P200-STD-EU", manage_inventory: false, allow_backorder: true, options: { "Voltage": "230V 50Hz (EU)" } },
      { title: "P 200 – Standard (110V US)", sku: "MULTIVAC-P200-STD-US", manage_inventory: false, allow_backorder: true, options: { "Voltage": "110V 60Hz (US)" } },
    ],
  })

  await upsertTranslation(p200.id, "de-DE", {
    title: "MULTIVAC BASELINE P 200",
    subtitle: "Tischkammermaschine mit optionaler Begasungseinrichtung",
    description:
      "Die MULTIVAC BASELINE P 200 ist eine vielseitige Tischkammermaschine mit einem nutzbaren " +
      "Kammervolumen von 305 × 300 × 110 mm und einer Pumpenleistung von 8 m³/h. Optional ist eine " +
      "Begasungseinrichtung für MAP-Packungen sowie eine alternative Deckelhöhe von 170 mm erhältlich.\n\n" +
      "Die P 200 verfügt über Doppelnaht-Trennsiegelung, eine steckbare Siegelschiene, die MCB01-Steuerung " +
      "und trägt das GS-Prüfzeichen. Ein fahrbares Untergestell ist als Zubehör erhältlich.\n\n" +
      "Technische Daten: Kammervolumen 305 × 300 × 110 mm | Maschinenabmessung 380 × 510 × 310 mm | " +
      "Gewicht ca. 36 kg | Pumpenleistung 8 m³/h | Siegellänge 305 mm | 230V 50Hz / 110V 60Hz",
  })

  await remoteLink.create({
    [Modules.PRODUCT]: { product_id: p200.id },
    [Modules.SALES_CHANNEL]: { sales_channel_id: salesChannel.id },
  }).catch(() => {})

  const p200Variants = p200.variants ?? []
  for (const { variantId, amount } of [
    { variantId: p200Variants[0]?.id, amount: 2500 },
    { variantId: p200Variants[1]?.id, amount: 2500 },
  ]) {
  ...
  logger.info("✅ BASELINE P 200 seed complete!")
