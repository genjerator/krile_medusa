...
export default async function seedC250({ container }: ExecArgs) {
  ...
  const c250 = await upsertProduct({
    ...
    metadata: {
      ...
      control_unit: "MC 06",
      sealing_bars: "2 × 465 mm",
      vacuum_pump_m3h: 21,

      // ─── Ausstattung ──────────────────────────────────────────────
      "ausstattung__laenge_siegelschiene_mm": "2 × 465",
      "ausstattung__kammertiefe_breite_mm": 285,
      "ausstattung__anzahl_siegelschienen": "1 × vorne, 1 × hinten",
      "ausstattung__kammerhoehe_mm": 150,
      "ausstattung__sichtfenster_sicherheitsglas": true,
      "ausstattung__vakuumpumpe_m3h": 21,
      "ausstattung__anschluss_externe_vakuumpumpe": "optional",
      "ausstattung__maschinenmasze_geschlossen_mm": "570 × 525 × 400",
      "ausstattung__maschinenmasze_geoeffnet_mm": "570 × 525 × 720",
      "ausstattung__gewicht_kg": 75,
