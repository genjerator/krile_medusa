...
export default async function seedP360({ container }: ExecArgs) {
  ...
  logger.info("🚀 Starting MULTIVAC BASELINE P 360 seed...")
  ...
  const p360 = await upsertProduct({
    title: "MULTIVAC BASELINE P 360",
    handle: "multivac-baseline-p360",
    subtitle: "Large tabletop vacuum chamber machine with dual sealing bars",
    images: [
      { url: `${BASE}/products/tabletop/p360-overview.jpg` },
      { url: `${BASE}/products/tabletop/p360-spec.jpg` },
    ],
    description:
      "The MULTIVAC BASELINE P 360 is the largest tabletop model in the BASELINE P series, " +
      "featuring a wide chamber volume of 440 × 460 × 170 mm and dual sealing bars (2 × 460 mm) " +
      "for packaging of longer products. Pump capacity is 20 m³/h.\n\n" +
      "The P 360 includes Doppelnaht-Trennsiegelung, MCB01 control unit, and optional gas flushing " +
      "for MAP packaging. It is the most capable tabletop machine in the BASELINE range.\n\n" +
      "Specifications: Chamber volume 440 × 460 × 170 mm | Machine dimensions 630 × 640 × 425 mm | " +
      "Weight ca. 80 kg | Pump capacity 20 m³/h | Sealing length 2 × 460 mm | 230V 50Hz / 110V 60Hz",
    status: "published",
    weight: 80000,
    length: 640,
    width: 630,
    ...
    metadata: {
      ...
      "ausstattung__kammerabmessung_mm": "440 × 460 × 170",
      "ausstattung__maschinenabmessung_mm": "630 × 640 × 425",
      "ausstattung__gewicht_kg": "ca. 80",
      ...
      "ausstattung__nutzbare_siegellaenge_mm": "2 × 460",
    ...
    variants: [
      { title: "P 360 – Standard (230V EU)", sku: "MULTIVAC-P360-STD-EU", manage_inventory: false, allow_backorder: true, options: { "Voltage": "230V 50Hz (EU)" } },
      { title: "P 360 – Standard (110V US)", sku: "MULTIVAC-P360-STD-US", manage_inventory: false, allow_backorder: true, options: { "Voltage": "110V 60Hz (US)" } },
    ],
  })

  await upsertTranslation(p360.id, "de-DE", {
    title: "MULTIVAC BASELINE P 360",
    subtitle: "Große Tischkammermaschine mit doppelter Siegelschiene",
    description:
      "Die MULTIVAC BASELINE P 360 ist das größte Tischmodell der BASELINE P-Serie mit einem " +
      "Kammervolumen von 440 × 460 × 170 mm und doppelter Siegelschiene (2 × 460 mm) für das " +
      "Verpacken längerer Produkte. Pumpenleistung: 20 m³/h.\n\n" +
      "Ausstattung: Doppelnaht-Trennsiegelung, MCB01-Steuerung, optionale Begasungseinrichtung " +
      "für MAP-Packungen. Die P 360 ist die leistungsstärkste Tischmaschine im BASELINE-Programm.\n\n" +
      "Technische Daten: Kammervolumen 440 × 460 × 170 mm | Maschinenabmessung 630 × 640 × 425 mm | " +
      "Gewicht ca. 80 kg | Pumpenleistung 20 m³/h | Siegellänge 2 × 460 mm | 230V 50Hz / 110V 60Hz",
  })

  await remoteLink.create({
    [Modules.PRODUCT]: { product_id: p360.id },
    [Modules.SALES_CHANNEL]: { sales_channel_id: salesChannel.id },
  }).catch(() => {})

  const p360Variants = p360.variants ?? []
  for (const { variantId, amount } of [
    { variantId: p360Variants[0]?.id, amount: 5500 },
    { variantId: p360Variants[1]?.id, amount: 5500 },
  ]) {
  ...
  logger.info("✅ BASELINE P 360 seed complete!")
